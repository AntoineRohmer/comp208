	...
	public LoginWindow() {
		...
		login_in.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				Main.MainFrameWindow = new MainFrame();
				setVisible(false);
			}
		});
		...
		/**
		 * final JLabel sign_in_1 = new JLabel("Havn't get a account yet?"); final
		 * GridBagConstraints LabelgridBagConstraints_2 = new GridBagConstraints();
		 * LabelgridBagConstraints_2.gridy = 3; LabelgridBagConstraints_2.gridx = 2;
		 ...
		 * gridBagConstraints_3 = new GridBagConstraints(); gridBagConstraints_3.gridy =
		 * 4; gridBagConstraints_3.gridx = 2; gridBagConstraints_3.insets = new
		 * Insets(0,50,0,150); gridBagConstraints_3.fill =
		 * GridBagConstraints.HORIZONTAL; sign.addActionListener(new SignUp());
