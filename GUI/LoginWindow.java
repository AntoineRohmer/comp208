...
public class LoginWindow extends JFrame {
    ...
    public LoginWindow() {
        ...
        final JButton login_in = new JButton("Login");
        ...
        login_in.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent arg0) {
                try {
                    int userText = Integer.parseInt(username.getText());
                    try {
                        ConnectionManager.checkLogin(userText);
                        System.out.println("You have input: " + userText);
                    } catch (Exception ex) {
         ...
         * final GridBagConstraints LabelgridBagConstraints_2 = new
         * GridBagConstraints(); LabelgridBagConstraints_2.gridy = 3;
         * LabelgridBagConstraints_2.gridx = 2; LabelgridBagConstraints_2.insets
         * = new Insets(10,0,0,0); LabelgridBagConstraints_2.fill =
         * GridBagConstraints.HORIZONTAL; container.add(sign_in_1,
         * LabelgridBagConstraints_2);
         *
         */
        /**
         * final JButton sign = new JButton("Sign in"); final GridBagConstraints
         * gridBagConstraints_3 = new GridBagConstraints();
         * gridBagConstraints_3.gridy = 4; gridBagConstraints_3.gridx = 2;
         * gridBagConstraints_3.insets = new Insets(0,50,0,150);
         * gridBagConstraints_3.fill = GridBagConstraints.HORIZONTAL;
         * sign.addActionListener(new SignUp()); container.add(sign,
